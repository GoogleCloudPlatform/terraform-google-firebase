...
| debug\_tokens | List of debug tokens to create for specific apps. | <pre>list(object({<br>    app_id       = string<br>    display_name = optional(string, "Debug Token")<br>    token        = string<br>  }))</pre> | `[]` | no |
