...
| enable\_auth\_management | Whether Terraform should manage the base Identity Platform configuration. Set to false if the auth config is managed externally or via the Firebase Console. | `bool` | `true` | no |
