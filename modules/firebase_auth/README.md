...
|------|-------------|------|---------|:--------:|
| auth\_config | Core configuration for Firebase Identity Platform. | <pre>object({<br>    allow_duplicate_emails  = optional(bool, false)<br>    anonymous_enabled       = optional(bool, false)<br>    email_enabled           = optional(bool, false)<br>    email_password_required = optional(bool, true)<br>    phone_enabled           = optional(bool, false)<br>    test_phone_numbers      = optional(map(string), {})<br>    authorized_domains      = optional(list(string), ["localhost"])<br>  })</pre> | `{}` | no |
